...
jQuery($=> {
    ...
    $("#submit_btn1 , #submit_btn").on('click', function () {
        ...
        if (proceed) {
            ...
            output = '<div class="alert-danger" style="padding:10px; margin-bottom:25px;">Veuillez renseigner le champ manquant..</div>';
            result.slideUp("fast").html(output).slideDown();
        }
    ...
    $(()=> {
        $tooltip.tooltipster({
            ...
            offset: [0, 0],
            animation: 'fade',
            content:'Cliquez ici pour fermer ou appuyez sur ESC!',
            delay: 20,

...
<head>
    ...
    {{-- <link rel="stylesheet" href="{{ asset('public/front/poles/style_rotation_pole.css') }}"> --}}
...
{{-- <body style="width: 100%;" onselectstart="return false" oncontextmenu="return false" ondragstart="return false" onMouseOver="window.status='..message perso .. '; return true;"> --}}
    ...
    {{-- Chargement de la page --}}
    <div class="loader">
        <img src="{{ asset('public/images/loader.gif') }}" alt="loader">
    </div>

    {{-- Sidebar --}}
    @include('front.pole.sidebar')
    <a class="btn" style="color: #fff; margin-top: 2%;"><i class="fas fa-bars"></i></a>
    <a class="btn" style="color: #fff; margin-top: 2%;"><img src="{{ asset('public/images/logo.png') }}" alt="logo"

...
@section('title')
    {{ __('traduction.Formation') }} | {{ __('traduction.' . $pole->nom_pole) }}
@endsection
...
<link rel="stylesheet" href="{{ asset('public/front/metiers/css/training.css') }}">
...
@section('content')
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" style="width: 100%;">
        <div class="text-center">
            <h1>@lang('traduction.Formation')</h1>
        </div>
        ...
        <div class="carousel-inner">
                            ...
                            <div class="u-clearfix u-expanded-width u-layout-wrap u-layout-wrap-1">
                                <div class="u-layout">
                                    ...
                                    <div class="u-layout-row">
                                        ...
                                        <div
                                            class="u-align-center-sm u-align-center-xs u-container-style u-layout-cell u-right-cell u-size-30 u-layout-cell-1 text-center">

                                            <div class="u-container-layout u-valign-top-xl u-container-layout-1">
                                                <div
                                                    class="u-align-center u-container-style u-expanded-width-lg u-expanded-width-md u-group u-shape-circle u-white u-group-1 cerclenom text-center">
                                                    <div class="u-container-layout u-valign-middle u-container-layout-2"
                                                        style="margin: 0 auto;">
                                                        <h3 class="u-text u-text-default u-text-1">
                                                            {{-- FORMATION TECHNIQUE DEVOPS --}}
                                                        </h3>
                                                        <h6 class="u-text u-text-default u-text-2">
                                                             {{ __('traduction.'.$formation->title) }}
                                                        </h6>
            ...
            @endforeach
            @include('front.layouts.formulaire_download')
        </div>
    ...
    <script src="{{ asset('public/front/metiers/js/training.js') }}"></script>
    <script>
        $(function() {

...
-->
    ...
    <link rel="stylesheet" href="{{ asset('public/front/metiers/css/fontawesome-all.min.css') }}">
    <link rel="stylesheet" href="{{ asset('public/front/metiers/css/bootstrap.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('public/front/metiers/css/magnific-popup.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('public/front/metiers/css/slick.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('public/front/metiers/css/slick-theme.css') }}" />
    <link rel="stylesheet" href="{{ asset('public/front/metiers/css/tooplate-style.css') }}">
...
<body>
    ...
    <div class="container-fluid tm-main">
        ...
        <div class="row tm-main-row">
            ...
            <div class="tm-copyright-text copyaroa">Copyright &copy; <span id="annee">
                </span> <a style="text-decoration: none;" rel="nofollow" href="https://www.aroapartners.com"> &nbsp
                    AroaLab</a>
            </div>
        </div>
    ...
    <script type="text/javascript" src="{{ asset('public/front/metiers/js/jquery.magnific-popup.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('public/front/metiers/js/jquery.backstretch.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('public/front/metiers/js/slick.min.js') }}"></script>
    <!-- Slick Carousel -->
    {{-- <script src="{{ asset('public/front/metiers/js/cacher_sidebar.js') }}"></script> --}}
    <script>
        $(function() {
            var tm_content = $('.tm-section')

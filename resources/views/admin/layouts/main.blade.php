...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper" id="app">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="{{ asset('public/images/logo.png') }}" alt="AdminLTELogo" height="60"
                width="60">
        </div>
    ...
    <script>
        class MyUploadAdapter {
            ...
            _initRequest() {
                ...
                // could be different.
                xhr.open('POST', '{{ route('admin.ckeditor.upload.image') }}', true);
            ...
            _initListeners(resolve, reject, file) {
                ...
                const genericErrorText = `Impossible de charger le fichier: ${ file.name }.`;
